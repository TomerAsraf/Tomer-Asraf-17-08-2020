...
// the api key become invalid very fast keep in mind that you might need to change to new one if the data is not showing up!!

  // alternative just in case :) API KEY = 1NoVPCfCBztljLoXYiAUmBQdMzABA3Sp
  const API_KEY = "ThwsVYGnxzuFLu3wI3LjUDznXdV5GS4x";
